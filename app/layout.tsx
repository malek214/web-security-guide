          ...
          <nav className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center gap-6">
                ...
                <a href="/tools" className="hover:text-primary-400 transition-colors">الأدوات</a>
                <a href="/best-practices" className="hover:text-primary-400 transition-colors">أفضل الممارسات</a>
                <a href="/resources" className="hover:text-primary-400 transition-colors">الموارد</a>
                <a href="/contact" className="hover:text-primary-400 transition-colors">تواصل معنا</a>
              </div>
