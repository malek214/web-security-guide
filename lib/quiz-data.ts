...
export const quizData: QuizData = {
  ...
  'phishing': [
    {
      ...
      options: [
        'هجوم تقني يستغل ثغرات في البرمجيات',
        'هجوم يعتمد على خداع المستخدم لسرقة معلوماته الحساسة',
        'هجوم على قواعد البيانات مباشرة',
        'هجوم ي胁迫 الضحية بالفدية',
      ],
      correctIndex: 1,
    },
    {
      question: 'ما هو التصيد الموجه (Spear Phishing)؟',
      options: [
        'تصيد عشوائي لمجموعة كبيرة من المستخدمين',
        'تصيد يستهدف شخصاً أو مؤسسة معينة باستخدام معلومات شخصية',
        'تصيد عبر المكالمات الهاتفية فقط',
        'تصيد عبر الرسائل القصيرة فقط',
      ],
      correctIndex: 1,
    },
    {
      question: 'كيف تحمي نفسك من التصيد الاحتيالي؟',
      options: [
        'باستخدام بريد إلكتروني فقط',
        'بالتحقق من هوية المرسل وعدم النقر على روابط مشبوهة',
        'بفتح جميع المرفقات لتตรวจสอบها',
        'بمشاركة كلمة المرور مع الزملاء',
      ],
      correctIndex: 1,
    },
    {
      question: 'أي من التالي يُعتبر علامة تحذيرية على التصيد؟',
      options: [
        'رسالة من جهة تعرفها',
        'رسالة تحمل إلحاح وعجلة ل录入 بيانات حساسة',
        'رسالة مكتوبة بلغة رسمية',
        'رسالة من نطاق الشركة الرسمي',
      ],
      correctIndex: 1,
    },
  ],
  'malware': [
    {
      question: 'ما هي البرمجيات الخبيثة (Malware)؟',
      options: [
        'برامج مجانية مفتوحة المصدر',
        'برامج صُمّمت لإلحاق الأذى بالنظام أو سرقة البيانات',
        'برامج لتحسين أداء الكمبيوتر',
        'برامج لحماية الخصوصية',
      ],
      correctIndex: 1,
    },
    {
      question: 'ما هو الفرق بين الفيروس والدود؟',
      options: [
        'لا يوجد فرق بينهما',
        'الفيروس يحتاج مضيفاً ليعمل، بينما الدود ينتشر تلقائياً عبر الشبكات',
        'الفيروس أخطر من الدود دائماً',
        'الدود لا يحتاج لل האינטרנט',
      ],
      correctIndex: 1,
    },
    {
      question: 'ما هو الشكل الأكثر خطورة من البرمجيات الخبيثة للشركات؟',
      options: [
        'الإعلانات الضارة (Adware)',
        'برامج الفدية (Ransomware)',
        'البرامج الجاسوسية (Spyware)',
        'الفيروسات البسيطة',
      ],
      correctIndex: 1,
    },
    {
      ...
      options: [
        'بتحميل البرامج من أي موقع',
        'باستخدام برامج مكافحة الفيروسات وتحديث النظام بانتظام',
        'بفصل الجهاز عن الإنترنت',
        'باستخدام نفس كلمة المرور لكل شيء',
      ],
      correctIndex: 1,
    },
  ],
  'social-engineering': [
    {
      question: 'ما هي الهندسة الاجتماعية في أمن المعلومات؟',
      options: [
        'علم تحسين أداء الأنظمة الاجتماعية',
        'استخدام تقنيات خداعية للتأثير على الناس ودفعهم للقيام بأفعال ضارة',
        'برمجة شبكات التواصل الاجتماعي',
        'تحسين واجهات المستخدم',
      ],
      correctIndex: 1,
    },
    {
      question: 'ما هو التحويل (Pretexting) في الهندسة الاجتماعية؟',
      options: [
        'استخدام USB مجاني لسرقة البيانات',
        'اختلاق سيناريو مزيف لخداع الضحية وجعله يكشف معلومات',
        'تتبع شخص للدخول لمنطقة محظورة',
        'عرض مساعدة في مقابل معلومات',
      ],
      correctIndex: 1,
    },
    {
      question: 'ما هو الإغراء (Baiting) في الهندسة الاجتماعية؟',
      options: [
        'بناء علاقة ودية مع الضحية',
        'استخدام إغراء مثل USB مجاني يحتوي على برمجيات خبيثة',
        'التصيد عبر البريد الإلكتروني',
        'الاتصال بالضحية للحصول على كلمة المرور',
      ],
      correctIndex: 1,
    },
    {
      question: 'كيف تحمي نفسك من هجمات الهندسة الاجتماعية؟',
      options: [
        'بمشاركة معلوماتك مع الجميع',
        'بالتحقق من هوية الشخص وعدم الثقة بمن لا تعرفه',
        'بفتح جميع الملفات المرسلة إليك',
        'باستخدام نفس كلمة المرور لكل الحسابات',
      ],
      correctIndex: 1,
    },
  ],
